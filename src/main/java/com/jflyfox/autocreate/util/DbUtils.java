...
import com.jflyfox.autocreate.db.DbDataTypesUtils;
...
public class DbUtils {
	 ...
	 * 
	 * 2015年4月22日 下午11:10:50 flyfox 330627517@qq.com
	 * 
	 * @param tables
	 * @return
	 * @throws SQLException
...
/*			if (table.getTableName().indexOf("_") >= 0) {
			...
			for (Column column : table.getColumns()) {
				...
				// 这里需要优化
				if (column.isPk() || "create_time".equals(colName) || "create_id".equals(colName)) {
					continue;
				}
	 ...
	 * 根据字段名和备注，设置属性
	 * 
	 * 2015年4月22日 下午10:56:20 flyfox 330627517@qq.com
	 * 
	 * @param model
	 * @param colName
	 * @param remark
